...
clients. Unilateral outcome simulation transports public-outcome bounds without
assuming any preferences for the deviator. The honest-profile law for this
same block service is needed separately before exporting Nash preservation.
-/
