...
/-! ## Machine-native strategy carriers and outcome kernels -/
...
/-- Machine-native behavioral strategy on a FOSG view. -/
...
profile, lifted to behavioral form. -/
...
/-- Machine-native behavioral strategy on a bounded FOSG view. -/
