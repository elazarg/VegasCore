...
/-!
# Checked-Program Outcome Adequacy Theorems

Project-facing names for the connection between terminal checked-program
event-graph states, declared payoff expressions, and strategic-form outcome
kernels.
-/
