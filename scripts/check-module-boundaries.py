...
VEGAS_LAYERS = {
    ...
    "Vegas.EventGraph": ("Vegas.Foundation", "Vegas.EventGraph"),
    "Vegas.Pending": ("Vegas.Foundation", "Vegas.Graph", "Vegas.EventGraph", "Vegas.Pending"),
    "Vegas.Compile": ("Vegas.Foundation", "Vegas.Source", "Vegas.Graph", "Vegas.EventGraph",
                      "Vegas.Compile"),
    "Vegas.Game": ("Vegas.Foundation", "Vegas.Source", "Vegas.Graph", "Vegas.EventGraph", "Vegas.Pending",
