...
abbrev Ctx (L : ExprLanguage) : Type := Distilled.Ctx L.Ty
abbrev Var (L : ExprLanguage) (Γ : L.Ctx) (τ : L.Ty) : Type := @Distilled.Var L.Ty Γ τ
abbrev Env (L : ExprLanguage) (Γ : L.Ctx) : Type := Distilled.Env L.Val Γ
