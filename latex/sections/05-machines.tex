...
\TT{Vegas.Machine.Adapter.ToMachine}.  Batch and checkpoint definitions are
in \TT{Vegas.EventGraph.Batch} and
\TT{Vegas.Compile.Checkpoint}.  The finite reachable-state
primitive machine is \TT{Vegas.Frontier.FiniteMachine}.}
