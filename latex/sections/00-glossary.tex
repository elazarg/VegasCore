...
\item[Kuhn's theorem (finite realization and deviation form).]
  ...
  bounded-FOSG theorem is stated directly on the finite-horizon FOSG
  carriers.  The same construction is packaged as a unilateral-deviation
  simulation: every behavioral deviation has a mixed-pure deviation with
  the same finite-horizon history law.  The native Vegas payoff-law
  statement follows by the proved native/FOSG strategy-equivalence and
  outcome-law transport.
...
mechanized; the supplement records the exact Lean type and field
list.
