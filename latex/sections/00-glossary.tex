...
\item[Kuhn's theorem (finite realisation form).]
  ...
  statement requires \emph{perfect recall}; the finite-Kuhn
  theorem of this report (\S\ref{sec:presentations}) is the
  bounded-FOSG analogue and is conditioned on a corresponding
  legal-observability hypothesis discharged from visibility and
  frontier stability.
