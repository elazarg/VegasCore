...
\item[Kuhn's theorem (finite realization and deviation form).]
  ...
  outcome-level realization result, with Nash-safe unilateral-deviation
  simulations for equilibrium transport.  FOSG and EFG bridges provide
  payoff-faithful presentations of the same frontier semantics; they are
  not the reduction used to prove the checked-program Kuhn statement.
