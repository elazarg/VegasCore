...
taking the game as the primitive object.  Closest in spirit to the end-to-end
ambition here, \citet{Caminati2015Auction} specify a combinatorial Vickrey
auction in Isabelle, verify its intended properties, and generate verified
executable code from the specification; that line shares the
``specification-to-running-artifact with checked properties'' goal, but for a
single fixed mechanism.  VegasCore's emphasis is orthogonal
and complementary: rather than a new existence theorem, or one verified
mechanism, it provides a checked
