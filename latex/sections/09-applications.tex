...
NisanRoughgardenTardosVazirani2007}.  In the present framework:
...
block-level actions.  It would then prove:
\begin{itemize}\itemsep1pt
...
threshold-of-revealers structures.  In the current surface this is a
...
Applications outside this scope would require extensions discussed in
