...
event-graph machine.  The bounded FOSG view remains the presentation used
for the generic FOSG Kuhn theorem and the canonical FOSG-to-EFG bridge.
The native/FOSG outcome-law transport needed for the public Kuhn theorem
is mechanised; what is not yet exposed is a single native augmented-EFG
object whose theorem states the composed FOSG-to-EFG and native/FOSG
adequacy result at once.
...
complete solver interchange format, and the PMF-behavioral carrier
