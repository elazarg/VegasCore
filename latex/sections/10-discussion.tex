...
\paragraph{FOSG-based strategic carriers.}  The event graph and
machine are the semantic source of truth, but the current
Vegas-facing pure and PMF-behavioural strategy carriers are routed
through the bounded FOSG view.  This is a checked view of the
machine, not a separate semantics.  A fully machine-native strategy
layer would reduce indirection and make the ``game form first''
story cleaner, but it is not yet the implemented carrier.
...
sanity-check theorems (payoff-vector agreement, Kuhn realisation,
