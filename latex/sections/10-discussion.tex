...
spaces~\citep{Harsanyi1967,MyersonGameTheory} fit by adding a
$\Sample$ layer that produces per-player private types via $\Commit$
of the $\Sample$ output.  The type system already supports this; a
mechanism-design library can be packaged as a checked
WFProgram-builder over a type-space schema.
...
sanity-check theorems (public-outcome agreement, Kuhn realisation,
