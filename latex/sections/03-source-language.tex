...
\TT{Vegas.WellFormed.Program}.  Surface syntax and let-erasing lowering are
in \TT{Vegas.Language.Basic}.  The concrete well-formedness predicates are
collected by \TT{Vegas.Core.Obligations}.}
