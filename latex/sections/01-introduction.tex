...
program to the strategic games and backend proof obligations it denotes.
...
simulator would be modeled as a lower-level machine: its states contain
...
\item \textbf{Runtime refinement.}  A stochastic refinement plus an
  ...
  of the selected frontier game surface.  With the strategy-space
  conditions of \Cref{sec:ref:cheap-talk} and bounded utility for the
  compared trace utilities, Nash equilibria on that surface pull back to
  the implementation trace game.  The direction is one-way:
  implementation equilibria do not automatically project back to
