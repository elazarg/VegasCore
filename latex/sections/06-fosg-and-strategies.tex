...
PMF-behavioural strategy carriers from the view, and present the
...
The FOSG round-action alphabet is static: independently of the
configuration, $\Act_p$ is the type
\[
  \Act_p \;=\; (n : \Nodes) \to \mathrm{Slice}(n),
\]
with the FOSG menu using $\mathsf{Option}(\Act_p)$ so that
