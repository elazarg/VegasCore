...
The native strategic layer now uses this round-batched shape
directly, without routing the definitions through FOSG.  FOSG is
still important: it is the external game-theory presentation used to
reuse the GameTheory library's FOSG-to-EFG bridge and finite Kuhn
theorem.  The relationship between the native round view and the
FOSG presentation is therefore a bridge theorem, not a definition.
