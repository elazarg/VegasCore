...
\subsection{Stored values and field patches}
...
(\textsf{hidden}). A \DefRef{FieldPatch} is a partial function from
fields to stored values: it records what fields a single event node
writes when it executes. The empty patch is the all-\textsf{none}
