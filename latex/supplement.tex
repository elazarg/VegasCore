...
statements require finite strategy carriers and a finite outcome
carrier. \TT{FiniteDomains g} supplies the former for the behavioral
strategy spaces, while the latter is a separate hypothesis because
Vegas outcomes are payoff vectors,
$\Outcome\,P = P \to_0 \mathbb{Z}$. Thus the current wrappers are best
read as conditional corollaries for finite-outcome presentations of a
Vegas game. They are stated at the PMF-over-strategies level and do
not themselves construct a named source-level policy.

\subsection{Mixed extension and Kuhn realization}
\label{def:Kuhn}
...
profile with the same outcome distribution — and does not itself
construct or prove the existence of any equilibrium. Existence proofs
compose Kuhn realization with a separate fixed-point existence theorem.
