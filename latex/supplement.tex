...
These are finite-game theorems in the library sense: their Lean
statements require finite nonempty strategy carriers and a finite
outcome carrier.  \TT{FiniteDomains g} supplies the finite operational
domains and the finite pure/reachable carriers used by the game
presentations; the behavioral strategy finiteness required by these
generic wrappers is stated explicitly when needed.  The outcome
hypothesis is separate because Vegas outcomes are payoff vectors,
$\Outcome\,P = P \to_0 \mathbb{Z}$.  The wrappers are conditional
corollaries for finite-outcome presentations of a Vegas game.  They are
stated at the PMF-over-strategies level and do not themselves construct
a named source-level policy.
