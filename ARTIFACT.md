...
| Concrete full-language pending target | `Vegas/Game/GraphMessages.lean` (completion, honest law, exact deviation mixture, and same-error Nash equivalence proved) |
...
lemmas. Its pending-message completion, honest-law, deviation-mixture, and Nash
capstones delegate to proved results for the actual compiler and native game.
