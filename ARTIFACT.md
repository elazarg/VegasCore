...
| In finite clocked perfect-recall protocols, consistent local optimality implies standard whole-policy sequential rationality, including off-path sites | `GameTheoryExtensions/Analysis/Protocol/SequentialOneShot.lean`, `GameTheoryExtensions/Analysis/Protocol/BehavioralOneShot.lean` |
| Standard SE exists for finite clocked perfect-recall protocols with a fully mixed reference, in the stated remaining-horizon contexts | `GameTheoryExtensions/Analysis/Protocol/SequentialExistence.lean` |
