...
independent of any list of bindings already resolved at a random prefix.
The readout retains public dispositions and frozen verifiers, including actual
public-default values, with their mutual correlations, in the final runtime
state. This does not backtranslate later player decisions or establish progress
under deviations; see the exact premises in
[runtime models](docs/runtime-models.md).
